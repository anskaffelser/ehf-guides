...
:Gnr: https://no.wikipedia.org/wiki/G%C3%A5rdsnummer
:Bnr: https://no.wikipedia.org/wiki/Bruksnummer
...
:V_betaling: https://test-vefa.difi.no/ehf/guide/invoice-and-creditnote/2.0/no/beskrivelse/utfylling-av-bankkontonummer.html[EHF implementasjonsguide kap 6.16]
